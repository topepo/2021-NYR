...
```{r resampling}
rs_results <- bind_rows(all_data, covid_data, interactions)
...
```{r testing}
cols <- c(Sun = "red", Mon = "black", Tue = "black", Wed = "black", Thu = "black", Fri = "black", Sat = "red")

test_results <- bind_rows(all_data_test, covid_data_test, interactions_test)
